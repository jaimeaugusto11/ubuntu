      ...
      <div className="p-6 space-y-6 md:space-y-7 sm:p-8">
        ...
        <h1 className="text-xl font-bold leading-tight tracking-tight text-backgroundColor md:text-2xl text-center">
          ...
          <p className="text-sm font-normal text-gray-500 mt-1">
            Venha e faça parte desta grande familia
          </p>
        </h1>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-1 gap-5 md:gap-6">
            <div className="relative">
              ...
              <input
                ...
                name="fullName"
                id="fullName"
                className=" border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-brightColor focus:border-brightColor block w-full pl-10 p-3 transition-all duration-200 shadow-sm"
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500">Ou criar com</span>
          </div>
        </div>
